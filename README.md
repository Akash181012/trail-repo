...
You can then execute your native executable with: `./target/account-management-service-1.0.0-SNAPSHOT-runner`
...
- Camel Direct ([guide](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/camel-quarkus-extensions-reference#extensions-direct)): Call another endpoint from the same Camel Context synchronously
